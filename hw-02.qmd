...
ggplot(df, aes(x = subject, y = value, fill = subject....c..A....B....C..)) +
  ...
  labs(
    ...
    caption = "TARGET\n\nhttps://www.geeksf,orgeeks.org/create-multiple-pie-charts-using-ggplot2-in-r/"
  )+
  theme(legend.position = "none")+
    theme(plot.caption = element_text(color = "red", size = 18, face = "bold", hjust = 0))
...
penguins%>% 
  drop_na(body_mass_g) %>% 
ggplot(aes(x = species, y = body_mass_g, color = island, size = body_mass_g))+
  geom_point()+
...
labs(
  ...
  theme(plot.title = element_text(color = "red", size = 18, face = "bold", hjust = 0),
        plot.subtitle = element_text(color = "purple", size = 10, face = "italics"))
